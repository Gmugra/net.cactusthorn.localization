...
public class LocalizationKey {
	...
	void combineWith(LocalizationKey key) {
		...
		if (key.defaultMessage != null)
			this.defaultMessage = key.defaultMessage;

		if (this.plurals != null && key.plurals != null)
			this.plurals.putAll(key.plurals);
		else if (this.plurals == null && key.plurals != null)
			this.plurals = key.plurals;

		if (this.specials != null && key.specials != null)
			this.specials.putAll(key.specials);
		else if (this.specials == null && key.specials != null)
			this.specials = key.specials;
	}
