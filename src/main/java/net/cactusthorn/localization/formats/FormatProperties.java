...
class FormatProperties {
    ...
    private LocalizationException localizationException(Locale _locale, String format, String value, String message, Exception e) {

        return new LocalizationException(_locale, "format: " + format + " -> " + message + ": \"" + value + "\"", e);
    }
}
