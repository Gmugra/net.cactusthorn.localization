...
public class FormatsTest {
    ...
    private static LocalDateTime localDateTimeEN;
    private static ZonedDateTime zonedDateTimeEN;

    private static java.util.Date date = new java.util.Date(1508570828338L);

    private static Locale ruRUlocale = new Locale("ru", "RU");
    ...
    public void testWrongClass() {
        ...
        Exception exception = assertThrows(LocalizationException.class, () -> formatsEN.format("special", enUSLocale));

        String expectedMessage = "Locale: en-US, format: \"special\", Unknown class for number formatting: java.util.Locale";
    ...
    public void testWrongDateTimeObject() {
        ...
        Exception exception = assertThrows(LocalizationException.class, () -> formatsEN.format("dt2", 22L));

        String expectedMessage = "Locale: en-US, format: \"dt2\", Unknown class for date/time formatting: java.lang.Long";
        String actualMessage = exception.getMessage();
    ...
    public void testUnknownFormat() {
        ...
        Exception exception = assertThrows(LocalizationException.class, () -> formatsEN.format("something", 22L));

        String expectedMessage = "Locale: en-US, Unknown format: \"something\"";
        String actualMessage = exception.getMessage();
